...
class PatronPrivilegePuja(Document):
    ...
    def validate_count(self):
        exisiting = frappe.db.count("Patron Privilege Puja", filters={"patron": self.patron, "active": 1})
        ...
        allowed = frappe.db.get_value("Patron Seva Type", patron_seva_type, "privilege_pujas")
